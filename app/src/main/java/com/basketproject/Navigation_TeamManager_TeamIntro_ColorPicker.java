...
/**
 * Created by park on 2016-05-18.
 */
public class Navigation_TeamManager_TeamIntro_ColorPicker extends Dialog {
    ...
    public Navigation_TeamManager_TeamIntro_ColorPicker(Context context, OnColorChangedListener listener,
